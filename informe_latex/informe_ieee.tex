...
% PAQUETES ESENCIALES
% ============================================================================
\usepackage[T1]{fontenc}  % Soporte para caracteres acentuados
\usepackage{cite}
...
\usepackage{textcomp}
\usepackage{xcolor}
% hyperref se mueve al final del preámbulo
\usepackage{listings}
\usepackage{float}
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, positioning, fit, backgrounds}
% inputenc y babel removidos por compatibilidad IEEE
...
\hypersetup{
    ...
    pdfkeywords={IoT AWS MQTT Kinesis DynamoDB LocalStack}
}
